...
IndoorPeopleDetectorOpenCVImpl::IndoorPeopleDetectorOpenCVImpl ():
classifier_()
{
 ...
 */
void IndoorPeopleDetectorOpenCVImpl::process (cv::Mat &mat)
{
...
void IndoorPeopleDetectorOpenCVImpl::setDB(const std::string &db)
{
...
void IndoorPeopleDetectorOpenCVImpl::setConfiguration(const std::string &file)
{
	XMLDocument xmlDoc;
	...
	XMLElement *pElement = pRoot->FirstChildElement("IndoorPeopleColor");
	std::string detectionColor = pElement->GetText();

	pElement = pRoot->FirstChildElement("IndoorPeopleMethod");
	method = stoi(pElement->GetText());

	pElement = pRoot->FirstChildElement("IndoorPeopleText");
